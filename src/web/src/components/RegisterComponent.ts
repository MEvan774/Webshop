...
export class RegisterComponent extends HTMLElement {
    ...
    private render(): void {
            ...
            <div class="registerForm">
                ...
                <div class="register-grid">
                    <div>
                        ...
                        <input type="text" id="fname" name="fname" class="fname" placeholder="Bert">
                    </div>
                    <div>
                        <label for="lname">Achternaam:</label>
                        <input type="text" id="lname" name="lname" class="lname" placeholder="Rongil">
                    </div>
                    <div>
        ...
        styleLink.setAttribute("href", "src/web/wwwroot/assets/css/registerPage.css");
