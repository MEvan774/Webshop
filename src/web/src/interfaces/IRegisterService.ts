...
export abstract class IRegisterService {
    ...
    public abstract registerUser(fname: string, lname: string, email: string, dob: string, gender: string, password: string, passwordRepeat: string): Promise<RegisterResult>;
