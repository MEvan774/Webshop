...
export class WelcomeComponent extends HTMLElement {
              ...
              <section class="discover">
                ...
                <div class="scroll-section">
                  ...
                  <div class="horizontal-scroll">
                      <!-- Game cards will be injected dynamically here -->
                  </div>
    ...
    public async fetchGamesData(): Promise<void> {
        try {
            ...
            if (Array.isArray(result) && result.length > 0) {
                ...
                console.error("No games data received or invalid structure.");
            }
        }
        catch (error: unknown) {
    ...
    private displayGames(games: GamesData[]): void {
        ...
        // Loop over the games and create HTML dynamically
        games.forEach(game => {
            const gameCard: HTMLDivElement = document.createElement("div");
            gameCard.classList.add("game-card");

            // Dynamically insert data for each game
            gameCard.innerHTML = `
